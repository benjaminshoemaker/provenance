...
- [ ] **[P1 / Low]** Fix delete document button error display — Button throws an error but the operation succeeds; UI shows an error message despite the document being deleted successfully. Likely a response handling issue in the delete action or a missing/incorrect redirect after deletion.
